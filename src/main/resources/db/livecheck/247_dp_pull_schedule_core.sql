-- Migration 247 additive-compatible livecheck; the runtime must require result=1.
WITH
expected_table AS (
...
SELECT IF(
  ...
  1,0
) AS schedule_core_additive_livecheck;
