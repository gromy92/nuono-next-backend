-- Add the pre-order profit selection pool menu under Procurement.
-- Menu id 9303 is already used by in-transit goods in production.
...
VALUES
  ...
  (9305, '选品池', 2, '/purchase/pre-order-profit', b'0', NOW(), NOW())
...
SET @pre_order_profit_menu_id = 9305;
