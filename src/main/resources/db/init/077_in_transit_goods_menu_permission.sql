...
-- 9301 belongs to file management; keep in-transit goods on a dedicated id.
...
VALUES
  ...
  (9302, '在途商品', 2, '/purchase/in-transit-goods', b'0', NOW(), NOW())
...
SET @in_transit_goods_menu_id = 9302;
