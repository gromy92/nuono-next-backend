...
final class ProductImageGenerationSubmittedEvent {
    private final Long suiteId;
    private final Long ownerUserId;
    private final String storeCode;
    private final Long operatorUserId;

    ProductImageGenerationSubmittedEvent(Long suiteId, Long ownerUserId, String storeCode, Long operatorUserId) {
