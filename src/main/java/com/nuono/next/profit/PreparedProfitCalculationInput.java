...
public class PreparedProfitCalculationInput {
    ...
    private final List<String> usedDefaultFields = new ArrayList<>();
    ...
    public List<String> getUsedDefaultFields() {
        return usedDefaultFields;
    }
