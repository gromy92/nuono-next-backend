...
public class CompetitorWatchProductRow {
    private Long id;
    ...
    public String getProductFulltypeSnapshot() { return productFulltypeSnapshot; }
    public void setProductFulltypeSnapshot(String productFulltypeSnapshot) { this.productFulltypeSnapshot = productFulltypeSnapshot; }
    ...
    public LocalDateTime getGmtUpdated() { return gmtUpdated; }
    public void setGmtUpdated(LocalDateTime gmtUpdated) { this.gmtUpdated = gmtUpdated; }
}
