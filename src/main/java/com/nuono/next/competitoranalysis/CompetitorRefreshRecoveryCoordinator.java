...
final class CompetitorRefreshRecoveryCoordinator {
    ...
    private final BiPredicate<OperationalTask, CompetitorWatchProductRow> executionAllowed;
    ...
    CompetitorRefreshRecoveryCoordinator(
            ...
            BiPredicate<OperationalTask, CompetitorWatchProductRow> executionAllowed,
    ...
    boolean resubmitQueued(
        ...
        if (!executionAllowed.test(task, watchProduct)) {
            return false;
        }
        return submit(
                task,
    ...
    private boolean submit(
        ...
        return taskDispatcher.submit(
                ...
                run,
                RUNNING_MESSAGE,
                () -> executionAllowed.test(task, watchProduct),
