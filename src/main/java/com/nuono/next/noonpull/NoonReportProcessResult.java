...
public class NoonReportProcessResult {
    ...
    private NoonReportProcessResult(Code code, int importedCount, int exceptionCount, String diagnosticDetail) {
        this.code = code;
    ...
    public static NoonReportProcessResult missingColumns(String diagnosticDetail) {
        return new NoonReportProcessResult(Code.MISSING_COLUMNS, 0, 0, diagnosticDetail);
    }
