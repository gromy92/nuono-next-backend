...
public interface Dp06AdvertisingGenerationMapper {
    @Insert({
            ...
            " declared_campaign_count,active_campaign_count,last_page,",
            ...
            " #{seed.command.activeCampaignCount},#{seed.manifest.knownLastPage},",
            " #{seed.manifest.dashboardItemCount},",
            " #{seed.manifest.dashboardBusinessSkippedItemCount},",
    ...
    @Select({
            ...
            " active_campaign_count AS activeCampaignCount,last_page AS lastPage,",
