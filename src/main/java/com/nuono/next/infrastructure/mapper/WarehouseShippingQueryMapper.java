...
@Select({
            ...
            "       source.source_party_name AS sourcePartyName,",
            ...
            "       warehouseSpec.product_length_cm AS productLengthCm, warehouseSpec.product_width_cm AS productWidthCm,",
            "       warehouseSpec.product_height_cm AS productHeightCm, warehouseSpec.product_weight_g AS productWeightG,",
            ...
            "  ON warehouseSpec.variant_id = source.product_variant_id",
