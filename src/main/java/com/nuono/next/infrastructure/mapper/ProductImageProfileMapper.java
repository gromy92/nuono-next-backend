...
public interface ProductImageProfileMapper {
    ...
    @Select({
            ...
            "  AND product_identity_key = #{productIdentityKey}",
            "  AND deleted = b'0'",
            "LIMIT 1"
    })
    ...
    @Insert({
            ...
            "  owner_user_id, store_code, psku_code, product_identity_key, product_master_id, product_variant_id,",
            ...
            ") VALUES (",
            "  #{ownerUserId}, #{storeCode}, #{pskuCode}, #{productIdentityKey}, #{productMasterId}, #{productVariantId},",
    ...
    @Select({
            ...
            " AND (pso.site_id = lss.id OR pso.site_code = lss.site)",
