...
public interface OfficialWarehouseMapper {
    ...
    @Select({
            ...
            "  AND 1 = (",
            "    SELECT COUNT(DISTINCT identityBarcode.logical_store_id, BINARY identityBarcode.partner_sku)",
            ...
            "     AND identityStore.owner_user_id = b.owner_user_id",
            "     AND identityStore.is_deleted = b'0'",
            "    WHERE 1 = 1",
            "      AND identityBarcode.is_deleted = b'0'",
