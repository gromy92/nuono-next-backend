...
public interface OfficialWarehouseMapper {
    ...
    @Select({
            ...
            "     AND (UPPER(COALESCE(line.psku, '')) IN (UPPER(COALESCE(psoScope.psku_code, '')), UPPER(COALESCE(pvScope.partner_sku, '')), UPPER(COALESCE(pvScope.child_sku, '')), UPPER(COALESCE(pmScope.sku_parent, ''))) ",
            "       OR UPPER(COALESCE(line.sku, '')) IN (UPPER(COALESCE(psoScope.psku_code, '')), UPPER(COALESCE(pvScope.partner_sku, '')), UPPER(COALESCE(pvScope.child_sku, '')), UPPER(COALESCE(pmScope.sku_parent, ''))) ",
            "       OR UPPER(COALESCE(line.msku, '')) IN (UPPER(COALESCE(psoScope.psku_code, '')), UPPER(COALESCE(pvScope.partner_sku, '')), UPPER(COALESCE(pvScope.child_sku, '')), UPPER(COALESCE(pmScope.sku_parent, ''))))",
            " ))",
            ...
            "    ))",
            "  )",
            "  AND (allocationScope.in_transit_goods_line_id IS NOT NULL",
            "       OR (UPPER(line.store_code) = UPPER(#{storeCode}) AND UPPER(line.site_code) = UPPER(#{siteCode})))",
            "  AND (",
