...
public interface CompetitorAnalysisMapper {
    ...
    @Select({
            ...
            "      OR LOWER(COALESCE(pm.title_cn_cache, '')) LIKE CONCAT('%', LOWER(#{query.productSearch}), '%')",
    ...
    @Select({
            ...
            "  CASE",
            "    WHEN UPPER(COALESCE(wp.self_noon_product_code, pso.psku_code, '')) LIKE 'Z%' THEN 'Z_CODE'",
            "    WHEN UPPER(COALESCE(wp.self_noon_product_code, pso.psku_code, '')) LIKE 'N%' THEN 'N_CODE'",
            "    ELSE NULL",
            "  END AS selfCodeType,",
            "  COALESCE(",
