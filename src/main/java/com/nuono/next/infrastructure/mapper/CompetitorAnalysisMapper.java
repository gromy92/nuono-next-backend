...
public interface CompetitorAnalysisMapper {
    ...
    @Select({
            ...
            "  pv.child_sku AS childSku, pm.sku_parent AS selfNoonProductCode,",
            "  CASE",
            "    WHEN UPPER(COALESCE(pm.sku_parent, '')) LIKE 'Z%' THEN 'Z_CODE'",
            "    WHEN UPPER(COALESCE(pm.sku_parent, '')) LIKE 'N%' THEN 'N_CODE'",
            "    ELSE NULL",
            "  END AS selfCodeType,",
            "  pm.title_cache AS titleSnapshot,",
            "  COALESCE(",
    ...
    @Select({
            ...
            "  AND (UPPER(pm.sku_parent) LIKE 'Z%' OR UPPER(pm.sku_parent) LIKE 'N%')",
