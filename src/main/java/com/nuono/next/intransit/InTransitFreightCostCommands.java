...
public final class InTransitFreightCostCommands {

    private InTransitFreightCostCommands() {
    }

    public static class ActualFreightSyncCommand {
        private Long ownerUserId;
        private Long operatorUserId;
        private BusinessAccessContext accessContext;
        private String sourceSystem;
        private List<ActualFreightBillCommand> bills = Collections.emptyList();
        ...
        public List<ActualFreightBillCommand> getBills() { return bills; }
        public void setBills(List<ActualFreightBillCommand> bills) {
            this.bills = bills == null ? Collections.emptyList() : bills;
        }
    }

    public static class ActualFreightBillCommand {
        ...
        private List<ActualFreightComponentCommand> components = Collections.emptyList();
        ...
        public List<ActualFreightComponentCommand> getComponents() { return components; }
        public void setComponents(List<ActualFreightComponentCommand> components) {
            this.components = components == null ? Collections.emptyList() : components;
        }
    }

    public static class ActualFreightComponentCommand {
    ...
    public static class SaveRateCardVersionCommand {
        private Long ownerUserId;
        private Long operatorUserId;
        ...
        private List<SaveRateCardRuleCommand> rules = Collections.emptyList();
        ...
        public List<SaveRateCardRuleCommand> getRules() { return rules; }
        public void setRules(List<SaveRateCardRuleCommand> rules) {
            this.rules = rules == null ? Collections.emptyList() : rules;
        }
    }

    public static class SaveRateCardRuleCommand {
        private String standardFeeType;
        private String rawFeeName;
    ...
    public static class SaveEstimateSnapshotCommand {
        private Long ownerUserId;
        private Long operatorUserId;
        ...
        private List<SaveEstimateComponentCommand> components = Collections.emptyList();
        ...
        public List<SaveEstimateComponentCommand> getComponents() { return components; }
        public void setComponents(List<SaveEstimateComponentCommand> components) {
            this.components = components == null ? Collections.emptyList() : components;
        }
    }

    public static class SaveEstimateComponentCommand {
        private String targetSiteCode;
        private String psku;
