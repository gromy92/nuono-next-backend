...
public class ProductSelectionSourceCollectionView {
    ...
    private Ali1688CollectionView ali1688Collection;
    ...
    public Integer getCollectedFieldCount() {
        return collectedFieldCount;
    }

    public void setCollectedFieldCount(Integer collectedFieldCount) {
        this.collectedFieldCount = collectedFieldCount;
    }

    public Integer getCollectedFieldTotal() {
        return collectedFieldTotal;
    }

    public void setCollectedFieldTotal(Integer collectedFieldTotal) {
        this.collectedFieldTotal = collectedFieldTotal;
    }

    public Integer getSpecAttributeCount() {
        return specAttributeCount;
    }

    public void setSpecAttributeCount(Integer specAttributeCount) {
        this.specAttributeCount = specAttributeCount;
    }
    ...
    public Ali1688CollectionView getAli1688Collection() {
        return ali1688Collection;
    }

    public void setAli1688Collection(Ali1688CollectionView ali1688Collection) {
        this.ali1688Collection = ali1688Collection;
    }
