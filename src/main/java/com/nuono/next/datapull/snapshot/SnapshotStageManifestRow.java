...
/** Aggregate-only database proof for a complete staged generation. */
public final class SnapshotStageManifestRow {
    private Long taskId;
    ...
    public Long getCanonicalItemCount() { return canonicalItemCount; }
    public void setCanonicalItemCount(Long value) { canonicalItemCount = value; }
