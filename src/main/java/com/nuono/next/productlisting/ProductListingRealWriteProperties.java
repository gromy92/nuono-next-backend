...
public class ProductListingRealWriteProperties {
    ...
    private boolean offerSplitWriteEnabled;
    ...
    public boolean isOfferSplitWriteEnabled() {
        return offerSplitWriteEnabled;
    }

    public void setOfferSplitWriteEnabled(boolean offerSplitWriteEnabled) {
        this.offerSplitWriteEnabled = offerSplitWriteEnabled;
    }
    ...
    public static class Endpoints {
        ...
        public static final String DEFAULT_UPSERT_OFFER_NOTE_URL =
        ...
        public String getUpsertOfferNoteUrl() {
            return upsertOfferNoteUrl;
        }

        public void setUpsertOfferNoteUrl(String upsertOfferNoteUrl) {
            this.upsertOfferNoteUrl = upsertOfferNoteUrl;
        }

        public String getUpsertIsActiveUrl() {
            return upsertIsActiveUrl;
        }

        public void setUpsertIsActiveUrl(String upsertIsActiveUrl) {
            this.upsertIsActiveUrl = upsertIsActiveUrl;
        }
