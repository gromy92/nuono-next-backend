...
public class AliAiBulkInquiryCreateProbeView {
    ...
    private String createPayloadDigest;
    ...
    public String getCreatePayloadDigest() {
        return createPayloadDigest;
    }

    public void setCreatePayloadDigest(String createPayloadDigest) {
