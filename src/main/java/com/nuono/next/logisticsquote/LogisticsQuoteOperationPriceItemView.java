...
public class LogisticsQuoteOperationPriceItemView {
    ...
    private Double minBillableUnit;
    ...
    public Long getQuoteVersionId() {
        return quoteVersionId;
    }

    public void setQuoteVersionId(Long quoteVersionId) {
        this.quoteVersionId = quoteVersionId;
    }

    public String getQuoteVersionNo() {
        return quoteVersionNo;
    }

    public void setQuoteVersionNo(String quoteVersionNo) {
        this.quoteVersionNo = quoteVersionNo;
    }
    ...
    public Double getMinBillableUnit() {
        return minBillableUnit;
    }

    public void setMinBillableUnit(Double minBillableUnit) {
