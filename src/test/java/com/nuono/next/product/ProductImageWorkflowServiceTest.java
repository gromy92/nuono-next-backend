...
class ProductImageWorkflowServiceTest {
    ...
    @Mock
    private ProductImageGenerator generator;
    @Mock
    private ObjectProvider<ProductImageNoonPublisher> publisherProvider;

    private ProductImageWorkflowService service;

    @BeforeEach
    void setUp() {
        service = new ProductImageWorkflowService(mapper, generator, publisherProvider, new ObjectMapper());
    }
    ...
    void reworkShouldReplaceSelectedAssetInsideTheSameSuite() {
        ...
        ProductImageSuiteAssetRecord main = asset(5001L, ProductImageSuiteAssetRole.MAIN, "/main.png", 10);
        ProductImageSuiteAssetRecord size = asset(5002L, ProductImageSuiteAssetRole.SIZE, "/size.png", 20);
