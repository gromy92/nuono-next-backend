...
def _module():
    spec = importlib.util.spec_from_file_location("retry_package_release", MODULE_PATH)
...
class NoonAuthRetryReleaseArtifactTest(unittest.TestCase):
    def test_packages_and_self_verifies_exact_retry_bundle(self):
        module = _module()
