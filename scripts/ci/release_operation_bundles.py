...
NOON_SCOPE_TAKEOVER_OPERATION_NAME = "noon_auth_owner_scope_takeover"
NOON_SCOPE_TAKEOVER_OPERATION_ENTRYPOINT = "scripts/noon_auth_owner_scope_takeover.py"
NOON_SCOPE_TAKEOVER_OPERATION_FILES = (
    NOON_SCOPE_TAKEOVER_OPERATION_ENTRYPOINT,
...
def freeze_operation_bundles(source_root: Path, output_root: Path) -> list[dict]:
    ...
    scope_takeover_paths = [root / name for name in NOON_SCOPE_TAKEOVER_OPERATION_FILES]
    return [
        ...
        _freeze(root, output, NOON_SCOPE_TAKEOVER_OPERATION_NAME,
                NOON_SCOPE_TAKEOVER_OPERATION_ENTRYPOINT, scope_takeover_paths),
    ]
...
__all__ = [
    ...
    "NOON_SCOPE_RELEASE_OPERATION_ENTRYPOINT",
    "NOON_SCOPE_TAKEOVER_OPERATION_FILES", "NOON_SCOPE_TAKEOVER_OPERATION_NAME",
    "NOON_SCOPE_TAKEOVER_OPERATION_ENTRYPOINT",
