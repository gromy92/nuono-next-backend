...
def prepare_current_release_fixture(database):
    database.client.execute(
        ...
        "KEY idx_shipping_batch_dispatch_plan "
        ...
        "is_active BIT(1) NOT NULL, active_state_source VARCHAR(80) DEFAULT NULL, "
        "active_state_synced_at DATETIME DEFAULT NULL, PRIMARY KEY (id), "
        "KEY idx_product_site_offer_replenishment_coverage "
        "(logical_store_id,site_id,maintenance_enabled,is_active)"
        ") ENGINE=InnoDB;"
        ...
        "KEY idx_product_master_store_sku_parent_lookup "
