    ...
    def test_catalog_owns_history_and_every_removed_runtime_schema(self):
        ...
        self.assertEqual(
            [
                ...
                "241_operations_competitor_correction_writer_fence.sql", "242_file_management_parse_retirement.sql", "243_dp_pull_runtime.sql", "244_dp_pull_report_bounded_apply.sql",
            ],
